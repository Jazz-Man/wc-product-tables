 ...
 */
class WC_Product_Grouped_Data_Store_Custom_Table extends WC_Product_Data_Store_Custom_Table
{
    ...
    protected function update_prices_from_children(&$product)
    {
        ...
        $min_price = $wpdb->get_var($wpdb->prepare("SELECT price
				...
				order by price ASC", $product->get_id())); // WPCS: db call ok, cache ok.
